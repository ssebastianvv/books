...
// guia estilos 
    render(id:string,title:string,author:string,description:string,summary:string,publicationDate:string):void{ // es void porque no buscamos que retorne algo solo que lo pinte 
